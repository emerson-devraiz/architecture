...
<body class="d-flex align-items-center">
    ...
    <div class="container-fluid d-flex justify-content-center">
        <div class="card" style="width: 25rem;">
            ...
            <form id="formLogin" action="/login" method="post" autocomplete="off">
                <div class="card-body">
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control email" id="email" name="email" obrigatorio="true" nome-validar="E-mail" placeholder="Digite seu E-mail" value="emerson_m_silveira@hotmail.com">
                        <label for="email">E-mail</label>
                    </div>
                    <div class="input-group">
                        <div class="form-floating">
                            <input type="password" class="form-control" id="password" name="password" obrigatorio="true" nome-validar="Senha" placeholder="Digite sua senha" value="emerson123">
